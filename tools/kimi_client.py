...
class KimiClient:
    def __init__(self):
        ...
        self.api_url = os.environ.get('KIMI_API_URL', 'https://api.moonshot.cn/v1/chat/completions')
        self.model = os.environ.get('KIMI_MODEL', 'kimi-k2.5')
    ...
    def _call_api(self, content_messages) -> str:
        ...
        try:
            ...
            if resp.status_code == 200:
                ...
                print(f"[KimiClient] {error_msg}")
                raise Exception(f"大模型解析失败: {error_msg}")
        except Exception as e:
            print(f"[KimiClient] 异常: {e}")
            raise e
